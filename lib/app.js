          ...
          { "sTitle": "", "mData": null, "bSortable": false, "sClass": "head0", "sWidth": "55px",
            "render": function (data, type, row, meta) {
              if (data.IsDirectory) {
                ...
                // "encodeURIComponent" (and "encodeURI") don't encoode single quotes! -- see:
                // https://stackoverflow.com/a/18251463
                var path = encodeURIComponent(data.Path).replace(/'/g, "%27");

                return "<a href='/b?" + rstr + "f=" + path +
